...
def geocoder_ville(nom_ville: str):
    ...
    Retourne (latitude, longitude, nom_affiche, region) ou None si introuvable."""
    try:
        resp = requests.get(
            GEOCODING_URL,
        ...
        region = r.get("admin1", "")
        return r["latitude"], r["longitude"], nom_affiche, region
...
def obtenir_meteo(nom_ville: str):
    ...
    if localisation is None:
        return None
    lat, lon, nom_affiche, region = localisation
